...
{
    if (strpos($string,base64_decode('5pyq5Yy56YWN5Yiw5pys5Z+f5ZCN')) !== false && Config::get('sn_info') !=='') {
        $string = base64_decode(Config::get('sn_info'));
        $info_tpl=CORE_PATH . '/template/accredit.html';
    }
